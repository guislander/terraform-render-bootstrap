...
variable "container_images" {
  ...
  default = {
    calico                  = "quay.io/calico/node:v3.14.1"
    calico_cni              = "quay.io/calico/cni:v3.14.1"
    coredns                 = "k8s.gcr.io/coredns:1.6.7"
    flannel                 = "quay.io/coreos/flannel:v0.12.0-amd64"
    flannel_cni             = "quay.io/coreos/flannel-cni:v0.3.0"
    kube_apiserver          = "k8s.gcr.io/kube-apiserver:v1.19.0-beta.2"
    kube_controller_manager = "k8s.gcr.io/kube-controller-manager:v1.19.0-beta.2"
    kube_scheduler          = "k8s.gcr.io/kube-scheduler:v1.19.0-beta.2"
    kube_proxy              = "k8s.gcr.io/kube-proxy:v1.19.0-beta.2"
    # experimental
    cilium_agent    = "docker.io/cilium/cilium:v1.8.0"
    cilium_operator = "docker.io/cilium/operator-generic:v1.8.0"
  }
}
